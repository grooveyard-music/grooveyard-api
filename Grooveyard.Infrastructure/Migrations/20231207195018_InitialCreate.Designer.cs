...
namespace Grooveyard.Infrastructure.Migrations
{
    ...
    [Migration("20231207195018_InitialCreate")]
            ...
            modelBuilder.Entity("Grooveyard.Domain.Models.Media.Mix", b =>
                {
                    ...
                    b.HasIndex("MusicFileId")
                        .IsUnique()
                        .HasFilter("[MusicFileId] IS NOT NULL");
            ...
            modelBuilder.Entity("Grooveyard.Domain.Models.Media.Tracklist", b =>
                {
                    ...
                    b.HasIndex("MixId")
                        .IsUnique()
                        .HasFilter("[MixId] IS NOT NULL");

                    b.ToTable("Tracklists");
                });

            modelBuilder.Entity("Grooveyard.Domain.Models.Media.TracklistSong", b =>
                {
                    b.Property<string>("TracklistId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("TracklistId", "SongId");

                    b.HasIndex("SongId");

                    b.ToTable("TracklistSongs");
                });
            ...
            modelBuilder.Entity("Grooveyard.Domain.Models.Media.Track", b =>
                {
                    b.HasOne("Grooveyard.Domain.Models.Media.Mix", "Mix")
                        .WithOne()
                        .HasForeignKey("Grooveyard.Domain.Models.Media.Track", "MediaId");
            ...
            modelBuilder.Entity("Grooveyard.Domain.Models.Media.Tracklist", b =>
                {
                    b.HasOne("Grooveyard.Domain.Models.Media.Mix", "Mix")
                        .WithOne("Tracklist")
                        .HasForeignKey("Grooveyard.Domain.Models.Media.Tracklist", "MixId")
                        .OnDelete(DeleteBehavior.Cascade);
