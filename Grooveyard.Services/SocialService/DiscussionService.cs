...
namespace Grooveyard.Services.SocialSercice
{
    public class DiscussionService : IDiscussionService
    {
        ...
        public DiscussionService(IDiscussionRepository discussionRepository, ILogger<DiscussionService> logger)
        {
        ...
        public async Task<List<DiscussionDto>> GetDiscussions()
        {
            ...
            var discussionDto = activeDiscussions.Select(d => new DiscussionDto
            {
                Id = d.Id,
                Title = d.Title,
